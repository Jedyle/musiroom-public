...
#                                 args=[ContentType.objects.get_for_model(content_object).pk, content_object.pk]))
#     else:
#         return redirect(reverse('discussions:search_discussion_for_object'))
#
#
# def search_discussion_for_object(request, content_id=None, object_id=None):
#     user = request.GET.get('auteur')
...
#
#     if user:
#         discussions = discussions.filter(user__username__icontains=user)
#     if title:
...
#         discussions = Discussion.objects.filter(user__username=username)
#         discs = []
