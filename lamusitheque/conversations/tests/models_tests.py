"""Tests for the models of the ``conversations`` app."""
...
class BlockedUserTestCase(TestCase):
    ...
    def setUp(self):
        self.blocked = mixer.blend('conversations.BlockedUser')
...
class ConversationTestCase(TestCase):
    ...
    def setUp(self):
        self.conversation = mixer.blend('conversations.Conversation')
...
class MessageTestCase(TestCase):
    ...
    def setUp(self):
        self.message = mixer.blend('conversations.Message')
