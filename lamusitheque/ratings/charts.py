...
class FolloweesRatingsBarChart(Chart):
    ...
    def get_datasets(self, album_id, username):
        ...
        return [{
            'data': count,
            'backgroundColor': ["#009997", "#009997", "#009997", "#009997", "#009997", "#009997", "#009997", "#009997",
                                "#009997", "#009997"],
        }]
...
class RatingsBarChart(Chart):
    ...
    def get_datasets(self, album_id):
        ...
        return [{
            'data': count,
            'backgroundColor': ["#808080", "#808080", "#808080", "#808080", "#808080", "#808080", "#808080", "#808080",
                                "#808080", "#808080"]
        }]
...
class UserRatingsBarChart(Chart):
    ...
    def get_datasets(self, username):
        ...
        return [{
            'data': count,
            'backgroundColor': ["#ffffff", "#aaaaaa", "#aaaaaa", "#aaaaaa", "#aaaaaa", "#aaaaaa", "#aaaaaa", "#aaaaaa",
                                "#aaaaaa", "#aaaaaa"]
        }]
