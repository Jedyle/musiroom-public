...
def ForbiddenUsernamesValidator(value):
    forbidden_usernames = ['admin', 'settings', 'news', 'about', 'help',
                           ...
                           'profil', 'utilisateur', 'contact', 'parametre', 'parametres', 'passe_oublie', 'passe_oublie_fin', 'activation', 'modifier', 'oublie', 'musique', 'message', 'messages', 'notes', 'notifications', 'feedback', 'supprimer' 
                           ]
